---
name: auth-security-standards
description: Authoritative standards, architectural boundaries, coding anatomy, and verification gates for auth.
version: 1.0.0
author: UniERP Architecture Governance
---

# UniERP Authentication & Security Primitives — AI Agent Guidance & Project Skill

This skill governs all code modification, analysis, and testing within `auth` (**Layer L1: Foundation**). Every AI agent and software engineer working in this repository MUST follow these rules without exception.
...
- **Allowed Inbound Callers**: L2-L5 (Runtime, Service, Presentation, Clients)
